    ...
    <div class="container-fluid navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a href="{{ url('#') }}" class="nav-link" id="mail-drop" data-bs-toggle="dropdown"
                            ...
                            <div class="p-0 card-body ">
                                ...
                                <a href="{{ url('#') }}" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                src="{{ asset('/assets/images/shapes/05.png') }}" alt="">
                                        </div>
                                        <div class="ms-3">
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center" href="{{ url('#') }}"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{ url('dashboard/app/user-profile.html') }}">Profile</a>
                        </li>
                        <li><a class="dropdown-item"
                                href="{{ url('dashboard/app/user-privacy-setting.html') }}">Privacy
                                Setting</a></li>
                        <li>
...
<x-header text="{{ isset($text) ? $text : '' }}" show="{{ isset($show) ? 'true' : 'false' }}"></x-header>    
<!--Nav End-->
